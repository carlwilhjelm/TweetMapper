...
In its current iteration the program identifies 2-grams in both the set of tweets with explicit references and the set of all tweets and maps the frequency of (Ke/e)/(Ka/a) with K (sub a or e) representing the number of instances over the set. 
